// Server-side mirror of scripts/eventWindow.js (Eastern Time boundaries).
// Kept in sync manually since api/ uses ES modules and scripts/ uses plain globals.
...
export function getEventPhase(nowDate = new Date()) {
...
export function isAllocationWindowOpen(nowDate = new Date()) {
